...
class PokemonsControllerTest < ActionController::TestCase
  ...
  test "should create pokemon" do
    assert_difference('Pokemon.count') do
      post :create, pokemon: { master_id: @pokemon.master_id, name: @pokemon.name, skills: @pokemon.skills }
    end
  ...
  test "should update pokemon" do
    patch :update, id: @pokemon, pokemon: { master_id: @pokemon.master_id, name: @pokemon.name, skills: @pokemon.skills }
    assert_redirected_to pokemon_path(assigns(:pokemon))
  end
